...
/**
 * com.lordjoe.sparkblast.FastaInputFormat
 * User: Steve
 * Date: 10/14/21
 * <p>
...
public class FastaInputFormat extends FileInputFormat<LongWritable, Text> {
     ...
     */
    public class FastaFileReader extends RecordReader<LongWritable, Text> {
